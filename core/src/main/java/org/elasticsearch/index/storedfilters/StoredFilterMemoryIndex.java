 ...
 * StoredFilterMemoryIndex index = new StoredFilterMemoryIndex();
 ...
 * <p>
 * StoredFilterMemoryIndex is not normally thread-safe for adds or queries.  However, queries
 ...
 * <p>
 * Example throughput of many simple term queries over a single StoredFilterMemoryIndex:
 ...
 *
 */
public class StoredFilterMemoryIndex {
     ...
     */
    public StoredFilterMemoryIndex() {
        this(false);
    }
     ...
     */
    public StoredFilterMemoryIndex(boolean storeOffsets) {
     ...
     */
    public StoredFilterMemoryIndex(boolean storeOffsets, boolean storePayloads) {
     ...
     */
    StoredFilterMemoryIndex(boolean storeOffsets, boolean storePayloads, long maxReusedBytes) {
     ...
     */
    public void addField(String fieldName, TokenStream tokenStream) {

        if (frozen) {
            throw new IllegalArgumentException("Cannot call addField() when StoredFilterMemoryIndex is frozen");
        }
        if (fieldName == null) {
        ...
        if (info == null) {
            ...
            FieldInfo fieldInfo = new FieldInfo(fieldName, fields.size(), false, false, false, indexOptions, DocValuesType.NONE, -1, Collections.emptyMap(), 0, 0);
            fields.put(fieldName, info = new Info(fieldInfo, byteBlockPool));
        }

        if (tokenStream != null) {
            storeTerms(info, tokenStream, boost, 0, 1);
        }
    }
...
//        if (DEBUG) System.err.println("token='" + term + "'");
    ...
    /**
     * Prepares the StoredFilterMemoryIndex for querying in a non-lazy way.
     * <p>
     * After calling this you can query the StoredFilterMemoryIndex from multiple threads, but you
    ...
    public abstract PostingsEnum getPostings(String field, BytesRef term, PostingsEnum reuse);
    ...
    public String toStringDebug() {
        ...
        final BytesRefBuilder payloadBuilder = null;
    ...
    /**
     * Resets the {@link StoredFilterMemoryIndex} to its initial state and recycles all internal buffers.
     */
    public void reset() {
        fields.clear();
