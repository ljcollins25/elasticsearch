...
import org.elasticsearch.plugin.mapper.MapperPrefixPlugin;
...
public class PrefixFieldMapperUpgradeTests extends ESIntegTestCase {

    @Override
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return Collections.singleton(MapperPrefixPlugin.class);
    }

    public void testUpgradeOldMapping() throws IOException, ExecutionException, InterruptedException {
        final String indexName = "index-mapper-prefix-2.0.0";
