...
public class PrefixFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void before() {
        ...
        mapperRegistry = new MapperRegistry(
                Collections.singletonMap(PrefixFieldMapper.CONTENT_TYPE, new PrefixFieldMapper.TypeParser()),
